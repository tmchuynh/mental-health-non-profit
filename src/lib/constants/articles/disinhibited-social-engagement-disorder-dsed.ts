          ...
          list: [
            {
              ...
              description:
                "Children with DSED may display no hesitation when approaching unfamiliar adults, showing physical affection or sharing personal details without restraint.",
            },
            {
              title: "Lack of Fear Toward Strangers",
              description:
                "They often fail to check back with caregivers in unfamiliar settings and may wander away without concern, showing limited awareness of personal safety.",
            },
            {
              title: "Superficial Social Interactions",
              description:
                "Despite appearing social, their interactions lack depth or emotional connection. They may struggle to form meaningful relationships with trusted caregivers.",
            },
          ],
        },
      ],
          ...
          list: [
            {
              ...
              description:
                "Children raised in group homes or orphanages without individualized care often fail to form selective attachments, leading to indiscriminate friendliness.",
            },
            {
              title: "Multiple Caregiver Changes",
              description:
                "Frequent changes in caregivers or foster placements can prevent a child from forming a secure attachment to any one individual.",
            },
            {
              title: "Parental Substance Abuse or Mental Illness",
              description:
                "Parents who are incapacitated by addiction or severe mental illness may be emotionally or physically absent during key developmental periods.",
            },
          ],
        },
      ],
          ...
          list: [
            {
              ...
              description:
                "Children with DSED often do not recognize or respect personal space or appropriate relational dynamics with peers and adults.",
            },
            {
              title: "Risk of Exploitation",
              description:
                "Because they trust too easily, these children are at higher risk of being taken advantage of by unsafe adults or older children.",
            },
            {
              title: "Peer Relationship Challenges",
              description:
                "Their behavior may alienate other children who view it as intrusive, confusing, or disruptive, making it hard for them to build stable friendships.",
            },
          ],
        },
      ],
          ...
          list: [
            {
              ...
              description:
                "Clinicians gather developmental and relational history from caregivers to assess the child’s early caregiving environment.",
            },
            {
              title: "Behavioral Observation",
              description:
                "Professionals observe the child’s interactions with unfamiliar adults and caregivers to assess attachment-related behavior.",
            },
            {
              title: "Exclusion of Other Disorders",
              description:
                "DSED must be differentiated from conditions like ASD or oppositional defiant disorder, which may present with some overlapping features.",
            },
          ],
        },
      ],
          ...
          list: [
            {
              ...
              description:
                "Stable, loving caregivers who set clear, appropriate boundaries are the foundation for recovery from DSED.",
            },
            {
              title: "Attachment-Based Therapy",
              description:
                "Specialized therapies aim to rebuild attachment capacity and teach relational cues through safe, structured interactions.",
            },
            {
              title: "School-Based Interventions",
              description:
                "Educators can support children with DSED by reinforcing social rules, providing structure, and encouraging peer acceptance.",
            },
          ],
        },
      ],
          ...
          list: [
            {
              ...
              description:
                "The sooner DSED is recognized, the sooner appropriate interventions can be implemented to support healthy development.",
            },
            {
              title: "Parental Education",
              description:
                "Training caregivers on attachment theory and trauma-informed care significantly improves outcomes.",
            },
            {
              title: "Systemic Reforms",
              description:
                "Reducing institutional care, stabilizing foster placements, and funding early childhood mental health programs are key steps in preventing attachment disorders.",
            },
          ],
        },
      ],

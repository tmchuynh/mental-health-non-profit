  ...
  return (
    <div className="mx-auto pt-3 md:pt-5 lg:pt-9 w-10/12 md:w-11/12">
      ...
      <div className="gap-2 grid lg:grid-cols-2">
        <div>
          <p>
            ...
            is a universal right that must be accessible and affirming to every
            individual, regardless of their background or identity. Our
          ...
          <p>
            We recognize that the mental health challenges faced by individuals
            are deeply intertwined with their cultural, social, and personal
            contexts. Marginalized communities often experience unique
            stressors, systemic barriers, and stigmas that can prevent them from
            seeking or receiving appropriate care. To address this, InnerLight
            Elevation intentionally cultivates a welcoming environment where
            people of all races, ethnicities, genders, sexual orientations,
            ages, abilities, socioeconomic statuses, religions, and lived
            experiences feel seen, heard, and valued.
          </p>
        </div>
        <div>
          <p>
            ...
            from diverse communities to ensure that our resources are relevant,
            respectful, and effective. We prioritize language access,
            representation in leadership and staff, and partnerships with
            organizations that serve underrepresented populations.
          </p>
          <p>
            ...
            healing, recognizing that collective resilience arises from the rich
            tapestry of perspectives, stories, and experiences.
          </p>
        </div>
      </div>
      ...
      <p>
        ...
        Elevation not only enriches the healing process but also contributes to
        building a more just, compassionate, and equitable society.
      </p>
    </div>
  );
}
